...
const NavBar = () => { 
  ...
  return (
    <Navbar bg="dark" variant="dark" expand="xl">
      <Navbar.Brand onClick={handleChnange} className='mb-1 ms-3'><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-menu-button-wide" viewBox="0 0 16 16">
